...
class QDESIGNER_WIDGET_EXPORT QMeter : public QWidget
{
    ...
    Q_PROPERTY(bool useGradient READ userGradient WRITE setUseGradient)
...
public:
    ...
    void setNeedlesFillColor(const QColor);
